...
## 设置编译环境
如何创建<pysource>文件，你可以找到一个模板文件： 
<root>/configs/pysource.template.sh
...
## 配置TELEMAC-MASCARET
如何创建<systel.cfg>文件，在 <root>/configs 下有一些配置文件模板
参考 systel.cfg

## 编译TELEMAC-MASCARET
`
设置环境变量：  source pysource.gfortranHPC.sh
显示配置：  config.py
编译telemac-mascaret： compile_telemac.py
`
