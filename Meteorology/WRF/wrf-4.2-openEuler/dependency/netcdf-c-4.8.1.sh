...
wget -t 0 -c -P $buildpath https://downloads.unidata.ucar.edu/netcdf-c/4.8.1/netcdf-c-4.8.1.tar.gz
...
./configure --prefix=$installpath/netcdf --enable-shared --enable-netcdf-4 --enable-dap --with-pic --disable-doxygen --enable-pnetcdf --enable-static --enable-largefile
