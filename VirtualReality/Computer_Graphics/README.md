...
- [OpenGL](./OpenGL/)：CG 基础库与 CUDA-OpenGL 交互
- [Off-screen Rendering](./Off-screen%20Rendering/)：OSMesa / EGL 离屏渲染
- [POVRay](./POVRay/)：CPU 光线追踪
- [Nvidia-IndeX](./Nvidia-IndeX/)：GPU 体渲染 / 光线追踪
- [proland-4.0](./proland-4.0/)：地球科学图形渲染
- [VTK](./VTK/)：CFD 常用可视化库
- [计算机图形学-Steve-Cunningham.md](./计算机图形学-Steve-Cunningham.md)
...
- [VirtualReality](../)：学科入口
- [ParaView](../ParaView/)：科学可视化主程序
- [In-situ-Visualization](../In-situ-Visualization/)：原位可视化
- [hpc-base](../../hpc-base/)：CUDA / OpenCL 等
