...
module load compilers/kunpenggcc/10.3.1/gcc10.3.1
module use /workspace/public/software/modules
module load mpi/openmpi/4.0.1_kunpenggcc10.3.1 
module use /workspace/public/software/modules
...
export MPI_INSTALL_PATH=/workspace/public/software/mpi/openmpi/4.0.1_kunpenggcc10.3.1
